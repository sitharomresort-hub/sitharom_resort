    ...
    <main className="pt-32 bg-cream dark:bg-[#120E0A] transition-colors duration-500">
      ...
      <div className="container mx-auto px-6 mb-24 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
        <div className="flex flex-col items-center p-8 bg-cream dark:bg-[#1C1610] border border-sand dark:border-gold/10 transition-colors duration-500">
          <span className="font-display text-3xl mb-4 text-clay dark:text-gold transition-colors duration-500">Address</span>
          <p className="font-medium text-villa-dark/90 dark:text-sand/90 text-base leading-relaxed transition-colors duration-500">
        ...
        <div className="flex flex-col items-center p-8 bg-cream dark:bg-[#1C1610] border border-sand dark:border-gold/10 transition-colors duration-500">
          <span className="font-display text-3xl mb-4 text-clay dark:text-gold transition-colors duration-500">Direct Contact</span>
          <p className="font-medium text-villa-dark/90 dark:text-sand/90 text-base flex flex-col gap-3 transition-colors duration-500">
            <a href="tel:+917306197613" className="hover:text-clay dark:hover:text-gold transition-colors">+91 73061 97613</a>
            ...
            <a href="https://wa.me/917306197613" target="_blank" rel="noopener noreferrer" className="hover:text-clay dark:hover:text-gold transition-colors text-clay-deep dark:text-gold mt-2">💬 Chat on WhatsApp</a>
          </p>
        </div>
        <div className="flex flex-col items-center p-8 bg-cream dark:bg-[#1C1610] border border-sand dark:border-gold/10 transition-colors duration-500">
          <span className="font-display text-3xl mb-4 text-clay dark:text-gold transition-colors duration-500">Social Media</span>
          <p className="font-medium text-villa-dark/90 dark:text-sand/90 text-base flex flex-col gap-3 transition-colors duration-500">
            ...
            <a href="https://facebook.com/sitharomresort" target="_blank" rel="noopener noreferrer" className="hover:text-clay dark:hover:text-gold transition-colors">Facebook</a>
            <a href="https://wa.me/917306197613" target="_blank" rel="noopener noreferrer" className="hover:text-clay dark:hover:text-gold transition-colors">WhatsApp</a>
          </p>
        </div>
      </div>
